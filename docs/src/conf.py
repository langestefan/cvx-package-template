...
def copy_examples():
    ...
    # Remove existing _examples directory if it exists
    ...
    if source_examples_dir.exists():
        for item in source_examples_dir.iterdir():
            if item.is_file():
                ...
                print(f"Copied {item.name} to {dest_examples_dir}")
            elif item.is_dir():
                shutil.copytree(item, dest_examples_dir / item.name)
                print(f"Copied directory {item.name} to {dest_examples_dir}")
    else:
        print(f"Warning: Source examples directory {source_examples_dir} "
              f"does not exist")
